...
const BlogDetailScreen = () => {
  // const { id } = useLocalSearchParams(); // TODO: fetch post based on id
  ...
  const post: BlogPost = {
    ...
    comments: [
      ...
      },
      {
        ...
        content:
          "Would love to see more examples of state management in React Native.",
        date: "May 17, 2023",
        likes: 2,
      },
    ],
          ...
          <View style={styles.contentContainer}>
            ...
            <View style={styles.commentsHeader}>
              <Text style={styles.commentsTitle}>
                Commentaires ({post.comments.length + comments.length})
              </Text>
            </View>
