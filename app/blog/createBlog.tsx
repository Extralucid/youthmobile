...
const CreateBlogPostScreen = () => {
    ...
    const submitBlogPost = () => {
        ...
        const readTime = Math.ceil(blogPost.content.split(' ').length / 200) + ' min read';
    ...
    return (
        ...
        >
            ...
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                ...
                >
                    {blogPost.coverImage ? (
                        <Image source={{ uri: blogPost.coverImage }} style={styles.coverImage} />
                    ) : (
                ...
                <View style={styles.section}>
                    ...
                    <TextInput
                        ...
                        onChangeText={(text) => setBlogPost({ ...blogPost, content: text })}
                    />
                ...
                {/* Author Info */}
                <View style={styles.section}>
                    <Text style={styles.sectionTitle}>Information de l'auteur</Text>
                    ...
                    >
                        {blogPost.author.avatar ? (
                            <Image source={{ uri: blogPost.author.avatar }} style={styles.avatar} />
                        ) : (
