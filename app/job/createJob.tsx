        ...
        >
            ...
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                ...
                <View style={styles.section}>
                    <Text style={styles.sectionTitle}> Information de l'employeur</Text>
                    ...
                    >
                        {job.employer.logo ? (
                            <Image source={{ uri: job.employer.logo }} style={styles.logo} />
                        ) : (
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.row}>
                        <View style={[styles.inputContainer, { flex: 1, marginRight: 10 }]}>
                            ...
                            <Picker
                                ...
                                style={styles.picker}
                                onValueChange={(itemValue) => setJob({ ...job, type: itemValue })}
                            >
                    ...
                    <View style={styles.inputContainer}>
                        ...
                        <ChipInput
                            values={job.skills}
                            onAddChip={(chip) => setJob({ ...job, skills: [...job.skills, chip] })}
                            onRemoveChip={(chip, index) => setJob({ ...job, skills: job.skills.filter((_, i) => i !== index) })}
                    ...
                    {job.responsibilities.map((item, index) => (
                        <View key={index} style={styles.listItem}>
                            ...
                            <TouchableOpacity
                                ...
                                onPress={() => removeItem('responsabilités', index)}
                            >
