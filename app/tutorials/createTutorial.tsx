  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={["top"]}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Créer un Tutoriel</Text>
        <View style={{ width: 24 }} />
      </View>
      <KeyboardAvoidingView
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          ...
          <View style={styles.section}>
            ...
            <TextInput
              ...
              onChangeText={(text) =>
                setTutorial({ ...tutorial, description: text })
              }
            />
            ...
            <View style={styles.row}>
              ...
              >
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setTutorial({ ...tutorial, duration: text })
                  }
                />
              </View>
              ...
              <View style={[styles.inputContainer, { flex: 1 }]}>
                ...
                <Picker
                  ...
                  onValueChange={(itemValue) =>
                    setTutorial({ ...tutorial, difficulty: itemValue })
                  }
                >
          ...
          <View style={styles.section}>
            ...
            {tutorial.sections.map((section, index) => (
              <View key={section.id} style={styles.listItem}>
                <Text style={styles.listItemTitle}>{`${index + 1}. ${
                  section.title
                }`}</Text>
            ...
            {showSectionForm && (
              <View style={styles.formContainer}>
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setNewSection({ ...newSection, title: text })
                  }
                />
                ...
                <View style={styles.inputContainer}>
                  ...
                  <Picker
                    ...
                    style={styles.picker}
                    onValueChange={(itemValue) =>
                      setNewSection({ ...newSection, type: itemValue })
                    }
                  >
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setNewSection({ ...newSection, duration: text })
                  }
                />
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setNewSection({ ...newSection, contentUrl: text })
                  }
                />
            ...
            {showResourceForm && (
              <View style={styles.formContainer}>
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setNewResource({ ...newResource, title: text })
                  }
                />
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setNewResource({ ...newResource, url: text })
                  }
                />
