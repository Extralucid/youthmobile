...
const PodcastDetailScreen = () => {
  ...
  const podcast: Podcast = {
    ...
    description: 'The latest in technology news and trends, delivered daily by industry experts. We cover everything from startups to enterprise tech, with interviews from leading figures in the industry.',
    category: 'Technology',
    episodesCount: 342,
    rating: 4.8,
    followers: 12500,
    episodes: [
      {
        ...
        description: 'In this episode, we discuss the major AI trends to watch in 2023 with Dr. Sarah Chen, AI researcher at Stanford University.',
        duration: '45:22',
        date: '2 days ago',
        audioUrl: 'https://images.unsplash.com/photo-1633356122544-f134324a6cee',
        listens: 1243
      },
      // More episodes...
    ],
        ...
        <View style={styles.headerInfo}>
          ...
          <View style={styles.metaContainer}>
            ...
            <View style={styles.metaItem}>
              ...
              <Text style={styles.metaText}>{podcast.followers.toLocaleString()}</Text>
            </View>
          </View>
          <TouchableOpacity 
      ...
      <View style={styles.section}>
        ...
        {podcast.episodes.map(episode => (
          ...
          >
            ...
            <Text style={styles.episodeDate}>{episode.date} • {episode.listens.toLocaleString()} En ecoute</Text>
        ...
        <View style={styles.section}>
          ...
          >
            {podcast.similarPodcasts.map(podcast => (
              <Link href={`/podcasts/podcastDetail`} key={podcast.id} asChild>
                <TouchableOpacity style={styles.similarPodcastCard}>
                  <Image 
                    source={{ uri: podcast.coverImage }} 
